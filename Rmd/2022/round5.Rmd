...
library(here)
library(glue)
ave_mape <- readRDS(here("data/2022/sn-assets-round-5/average_mape.rds"))
...
```{r prediction-table}
preds <- readRDS(here("data/2022/sn-assets-round-5/predictions.rds"))
knitr::kable(preds)
...
```{r results-table}
results_table <- readRDS(here("data/2022/sn-assets-round-5",
  "results_mape.rds"))
