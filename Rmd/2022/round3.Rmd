...
library(here)
library(glue)
ave_mape <- readRDS(here("data/2022/sn-assets-round-3/average_mape.rds"))
...
```{r prediction-table}
preds <- readRDS(here("data/2022/sn-assets-round-3/predictions.rds"))
knitr::kable(preds)
...
```{r results-table}
results_table <- readRDS(here("data/2022/sn-assets-round-3",
  "results_mape.rds"))
