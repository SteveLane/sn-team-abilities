---
title: "Round 15, 2018"
subtitle: "Round 14 Wrapup and Round 15 Analysis"
---

<!-- Time-stamp: <2018-08-10 16:07:56 (slane)> -->
...
knitr::opts_chunk$set(cache = FALSE, error = FALSE, warning = FALSE,
                      ...
                      fig.asp = 9/16, cache.path = "round15-2018_cache/")
options(digits = 2)
...
if (!dir.exists(here("Rmd", "sn-assets", "round15-2018"))) {
    dir.create(here("Rmd", "sn-assets", "round15-2018"), recursive = TRUE)
}
...
```{r round-download}
season_2018 <- updateData(previous_round)
...
res <- sapply(1:2, predDiffHist, model = output, game_lookup = round_data)
## Create a 2x1 grid of the figures.
pl_grid <- plot_grid(res[[1, 1]], res[[1, 2]])
save_plot(here("figs", paste0(dir_text, "-plot-grid.png")),
          pl_grid, base_height = 35 / (1 + sqrt(5)), base_width = 35)
