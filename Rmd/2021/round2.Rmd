...
<!-- Time-stamp: <2021-05-03 18:38:16 (sprazza)> -->
...
Predictions for the second round are given in the table below. The priors for these distributions are based on the final abilities from last season and the results from round 1.

```{r prediction-table}
preds <- readRDS(here("data/2021/sn-assets-round-2", "predictions.rds"))
knitr::kable(preds)
