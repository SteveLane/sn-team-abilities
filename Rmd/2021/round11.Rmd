...
library(here)
library(glue)
ave_mape <- readRDS(here("data/2021/sn-assets-round-11/average_mape.rds"))
...
```{r prediction-table}
preds <- readRDS(here("data/2021/sn-assets-round-11/predictions.rds"))
knitr::kable(preds)
...
```{r results-table}
results_table <- readRDS(here("data/2021/sn-assets-round-11",
  "results_mape.rds"))
