...
<!-- Time-stamp: <2021-06-05 10:47:04 (sprazza)> -->
...
library(here)
library(glue)
ave_mape <- readRDS(here("data/2021/sn-assets-round-6/average_mape.rds"))
...
```{r prediction-table}
preds <- readRDS(here("data/2021/sn-assets-round-6/predictions.rds"))
knitr::kable(preds)
...
The following figure shows the results (score difference of the home team) in [round 5]({{< relref "2021-06-04-round5.md" >}}) (blue vertical line) against the predictions from the model.
...
```{r results-table}
results_table <- readRDS(here("data/2021/sn-assets-round-6",
  "results_mape.rds"))
