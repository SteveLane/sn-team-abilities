...
```{r libraries}
library(here)
ave_mape <- readRDS(here("data/2020/sn-assets-round-6", "average_mape.rds"))
...
```{r prediction-table}
preds <- readRDS(here("data/2020/sn-assets-round-6", "predictions.rds"))
knitr::kable(preds)
...
```{r results-table}
results_table <- readRDS(here("data/2020/sn-assets-round-6",
  "results_mape.rds"))
